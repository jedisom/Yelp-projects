...
review.good <- review1[review1$stars >= 4, ]
review.bad <- review1[review1$stars < 4, ]
...
dtm.good   <- dtm.good[rowTotals> 0, ] #remove all docs without words
